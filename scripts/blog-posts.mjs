...
export const blogPosts = [
  {
    ...
    desc: "What affects garage door repair quotes in Ottawa — springs, cables, openers & door size. How on-site estimates work across Kanata, Barrhaven, Orleans & suburbs.",
...
`,
  },
  {
    ...
    desc: "Broken garage door spring in Ottawa? Safety steps for torsion & extension springs, when to stop using the opener, and professional spring replacement in Kanata, Barrhaven & suburbs.",
...
<p>Call or text <a href="tel:+16139006005">(613) 900-6005</a> if the door is stuck open overnight, hanging on one side, or you suspect a broken spring or cable. We are available every day, 7 a.m.–9 p.m., with priority scheduling when routes allow.</p>
`,
  },
  {
