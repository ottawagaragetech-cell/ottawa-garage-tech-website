window.OGT = {
  ...
  images: {
    ...
    installCarpWhite: "/assets/gallery/install-carp-white.png",
    installBeigeBrick: "/assets/gallery/install-beige-brick.png",
  ...
  homeGallery: [
    ...
    {
      src: "/assets/gallery/install-carp-white.png",
      alt: "White garage door with top windows installed on red brick — Carp area",
      cap: "White door · west rural",
    },
    {
      src: "/assets/gallery/install-beige-brick.png",
      alt: "Beige raised-panel garage door on red brick — Ottawa install",
      cap: "Beige door · brick home",
    },
    {
  ...
  showcase: [
    ...
    { srcKey: "installCarpWhite", alt: "White garage door with windows on red brick — Ottawa install", cap: "White door install" },
  ...
  gallery: [
    ...
    { srcKey: "installCarpWhite", alt: "White garage door with top windows on red brick — Carp area install", cap: "White door · west rural", cat: "install" },
    { srcKey: "installBeigeBrick", alt: "Beige raised-panel garage door on red brick — Ottawa install", cap: "Beige door · brick home", cat: "install" },
  ...
  trustBadges: [
    ...
    { title: "Evening hours", text: "Every day, 7 a.m.–9 p.m., including after work" },
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Phone or text (613) 900-6005 is best when the door will not close or a spring just broke. We are available every day from 7 a.m. to 9 p.m. and prioritize safety issues such as off-track doors or failed springs."
    },
    {
      category: "service",
    ...
    },
    {
      category: "service",
      q: "When are you open?",
      a: "Every day, 7 a.m. to 9 p.m., including evenings. For urgent problems, calling or texting beats email."
    },
    {
      category: "service",
